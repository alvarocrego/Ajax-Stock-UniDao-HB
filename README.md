...
UniDao stands for only one generic DAO class.
HB stands for Hibernate.

Desarrollo de aplicaciones web. CPIFP Ausiàs March. Curso 2013-2014.

## ¿Qué es ajax stock?
Es una aplicación didáctica para aprender a organizar y desarrollar aplicaciones AJAX. Se trata de un proyecto que construimos durante la segunda evaluación de los módulos DES-DEC del ciclo formativo DAW. Está pensado para soportar mantenimientos CRUDL (create remove update delete list). Utiliza el framework de persistencia Hibernate.
...
* HB indica que ha sido desarrollado utilizando el framework de persistencia Hibernate</li>
* UNI-DAO tiene la característica especial de que tiene una clase DAO genérica sobre Hibernate
